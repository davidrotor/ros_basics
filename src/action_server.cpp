...
#include "ros_basics/demo_actionAction.h"
#include "ros/ros.h"
...
protected:
  ...
  actionlib::SimpleActionServer<ros_basics::demo_actionAction> as;
  // create messages that are used to published feedback/result
  ros_basics::demo_actionFeedback feedback;
  ros_basics::demo_actionResult result;
...
public:
  ...
  void executeCB(const ros_basics::demo_actionGoalConstPtr &goal)
  {
